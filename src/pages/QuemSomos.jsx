...
function QuemSomos() {
  return (
    ...
    <div className="min-h-screen bg-[#0B1016] font-['Poppins',sans-serif]">
      ...
      <header className="sticky top-0 z-50 border-b border-[#1C2A35] bg-[#0B1016]/80 backdrop-blur-sm">
      ...
      {/* Seção Principal com a nova paleta */}
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-left bg-[#14222E]/50 p-8 md:p-12 rounded-2xl border border-[#1C2A35] shadow-2xl">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center">
              Mais que Ferramentas. <span className="bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] bg-clip-text text-transparent">Uma Jornada.</span>
            </h2>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Percebi que nesse mar de informações, o que mais falta é <span className="text-[#5EEAD4] font-semibold">sentido</span>.
            </p>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Foi dessa lacuna que nasceu o <span className="text-[#5EEAD4] font-semibold">Nexus</span>.
            </p>

            <p className="text-gray-300 leading-relaxed mb-6">
              Não somos mais um lugar que só te vende algo. Somos um espaço de <span className="text-[#5EEAD4] font-semibold">construção</span>.
            </p>
            ...
            <p className="text-xl text-[#5EEAD4] leading-relaxed mb-6 font-semibold">
              Fazer o binômio entre I.A. e Transformação Pessoal.
            </p>
            
            <p className="text-gray-300 leading-relaxed mb-6">
              Queremos conduzir você a um patamar elevado de uso consciente da tecnologia — onde você não apenas executa, mas <span className="text-[#5EEAD4] font-semibold">compreende</span>; não apenas repete, mas <span className="text-[#5EEAD4] font-semibold">cria</span>; não apenas consome, mas <span className="text-[#5EEAD4] font-semibold">se desenvolve</span>.
            </p>
            
            <p className="text-gray-300 leading-relaxed mb-6">
              E no centro disso tudo está o que acreditamos ser o grande catalisador da mudança real: <span className="text-[#5EEAD4] font-semibold">A comunicação.</span>
            </p>
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              É por isso que no Nexus você não encontra apenas listas de ferramentas ou tutoriais rasos. Você encontra um <span className="text-[#5EEAD4] font-semibold">guia para alto desempenho cognitivo e emocional</span>, com base em pilares como:
            </p>

            <ul className="space-y-4 my-8">
              <li className="flex items-start">
                <CheckCircle className="w-6 h-6 text-[#2DD4BF] mr-3 mt-1 flex-shrink-0" />
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              Nosso compromisso é com seu crescimento real. Queremos que você use a I.A. não para ser substituído, mas para se tornar <span className="text-[#5EEAD4] font-semibold">mais humano</span>.
            </p>
            ...
            <p className="mt-10 text-xl italic text-center text-[#2DD4BF] font-medium">
