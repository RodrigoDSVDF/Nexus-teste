      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#0B1016] to-[#14222E]">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <div className="inline-flex items-center px-4 py-2 sm:px-6 sm:py-3 bg-[#2DD4BF]/20 border border-[#2DD4BF]/30 rounded-full text-[#5EEAD4] text-xs sm:text-sm font-medium mb-4 sm:mb-6">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center mb-12">
            <AnimatedFromLeft>
              <div className="space-y-6">
                <div className="bg-[#14222E]/50 p-6 rounded-2xl border border-[#1C2A35]">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
                    <Cpu className="w-6 h-6 sm:w-8 sm:h-8 text-[#5EEAD4] mr-3" />
                ...
                <div className="bg-[#0D3A46]/30 p-6 rounded-2xl border border-[#2DD4BF]/20">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-4 flex items-center">
                    <Zap className="w-6 h-6 sm:w-8 sm:h-8 text-[#5EEAD4] mr-3" />
                    A Solução: IA Como Seu Mentor 24/7
                  </h3>
                  <ul className="space-y-3 text-gray-300 text-sm sm:text-base">
                    <li className="flex items-start">
                      <CheckCircle className="w-5 h-5 text-[#2DD4BF] mr-3 mt-0.5 flex-shrink-0" />
            ...
            <AnimatedFromRight>
              <div className="bg-[#0B1016] p-6 rounded-2xl border border-[#1C2A35]">
                <h3 className="text-xl sm:text-2xl font-bold text-white mb-6 text-center">
                  Como a IA Transforma Seu Cérebro em Uma Máquina de Aprendizado
                </h3>
                
                <div className="space-y-4">
                  <div className="flex items-start p-4 bg-[#14222E]/50 rounded-xl border border-[#1C2A35] hover:border-[#2DD4BF]/30 transition-all duration-300">
                    <div className="w-10 h-10 bg-gradient-to-r from-[#14222E] to-[#0D3A46] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <Brain className="w-5 h-5 text-[#5EEAD4]" />
                    </div>
                    <div>
                      <h4 className="text-white font-bold text-sm sm:text-base mb-1">Neuro-Aceleração</h4>
                      <p className="text-gray-300 text-xs sm:text-sm">IA identifica seus padrões de aprendizado e cria rotas neuronais otimizadas</p>
                    </div>
                  </div>

                  <div className="flex items-start p-4 bg-[#14222E]/50 rounded-xl border border-[#1C2A35] hover:border-[#2DD4BF]/30 transition-all duration-300">
                    <div className="w-10 h-10 bg-gradient-to-r from-[#0D3A46] to-[#14222E] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <Workflow className="w-5 h-5 text-[#5EEAD4]" />
                    </div>
                    <div>
                      <h4 className="text-white font-bold text-sm sm:text-base mb-1">Memória Expandida</h4>
                      <p className="text-gray-300 text-xs sm:text-sm">Sistema de repetição espaçada inteligente que nunca deixa você esquecer</p>
                    </div>
                  </div>

                  <div className="flex items-start p-4 bg-[#14222E]/50 rounded-xl border border-[#1C2A35] hover:border-[#2DD4BF]/30 transition-all duration-300">
                    <div className="w-10 h-10 bg-gradient-to-r from-[#14222E] to-[#0D3A46] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
                      <BarChart className="w-5 h-5 text-[#5EEAD4]" />
                    </div>
                    <div>
                      <h4 className="text-white font-bold text-sm sm:text-base mb-1">Atualização Automática</h4>
                      <p className="text-gray-300 text-xs sm:text-sm">Sempre aprendendo as tendências mais recentes do mercado automaticamente</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6">
            <AnimatedSection delay={0.2}>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#14222E] to-[#0D3A46] rounded-2xl border border-[#2DD4BF]/20">
                <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">3x</div>
                <div className="text-white font-semibold text-xs sm:text-sm">Mais Rápido</div>
                <div className="text-gray-300 text-xs">Aprendizado acelerado</div>
              </div>
            </AnimatedSection>

            <AnimatedSection delay={0.3}>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#0D3A46] to-[#14222E] rounded-2xl border border-[#2DD4BF]/20">
                <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">90%</div>
                <div className="text-white font-semibold text-xs sm:text-sm">Retenção</div>
                <div className="text-gray-300 text-xs">Do conhecimento</div>
              </div>
            </AnimatedSection>

            <AnimatedSection delay={0.4}>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#14222E] to-[#0D3A46] rounded-2xl border border-[#2DD4BF]/20">
                <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">24/7</div>
                <div className="text-white font-semibold text-xs sm:text-sm">Mentoria</div>
                <div className="text-gray-300 text-xs">IA sempre disponível</div>
              </div>
            </AnimatedSection>

            <AnimatedSection delay={0.5}>
              <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#0D3A46] to-[#14222E] rounded-2xl border border-[#2DD4BF]/20">
                <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">10h+</div>
                <div className="text-white font-semibold text-xs sm:text-sm">Economia</div>
                <div className="text-gray-300 text-xs">Por semana</div>
              </div>
            </AnimatedSection>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-5 gap-6 sm:gap-8 items-center">
              ...
              <AnimatedFromLeft>
                <div>
                  ...
                  <ul className="space-y-2 sm:space-y-3 text-gray-300 text-sm sm:text-base">
                    <li className="flex items-start">
                      <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-[#2DD4BF] mr-2 sm:mr-3 mt-0.5 flex-shrink-0" />
                ...
                <div>
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    <div className="flex items-center">
                      <Book className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-3 sm:mr-4" />
                      <span className="text-gray-300 text-sm sm:text-base"><strong>Horas de Estudo:</strong> Fator mais decisivo</span>
                    </div>
                    <div className="flex items-center">
                      <BarChart3 className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-3 sm:mr-4" />
                      <span className="text-gray-300 text-sm sm:text-base"><strong>Notas Anteriores:</strong> Indicador de sucesso</span>
                    </div>
                    <div className="flex items-center">
                      <Bed className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-3 sm:mr-4" />
                      <span className="text-gray-300 text-sm sm:text-base"><strong>Qualidade do Sono:</strong> Impacto direto</span>
                    </div>
                    <div className="flex items-center">
                      <UserCheck className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-3 sm:mr-4" />
                      <span className="text-gray-300 text-sm sm:text-base"><strong>Presença nas Aulas:</strong> Consistência é crucial</span>
                    </div>
                  </div>
                </div>
              </AnimatedFromLeft>
            ...
            <div className="lg:col-span-3">
              <AnimatedFromRight>
                <div className="bg-[#14222E]/50 p-3 sm:p-4 rounded-2xl border border-[#1C2A35] shadow-2xl hover:border-[#0D3A46] transition-all duration-300">
                  <iframe
      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#0B1016] to-[#14222E]">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-12">
            {/* PDF */}
            <AnimatedSection delay={0.2}>
              <div className="group bg-gradient-to-br from-[#14222E] to-[#0D3A46] p-4 sm:p-6 rounded-2xl border border-[#2DD4BF]/20 hover:border-[#2DD4BF] transition-all duration-300 h-full flex flex-col">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-r from-[#14222E] to-[#0D3A46] rounded-2xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-300">
                    <BookOpen className="w-5 h-5 sm:w-7 sm:h-7 text-[#5EEAD4]" />
                  </div>
                ...
                <div className="bg-[#0B1016]/50 p-2 sm:p-3 rounded-xl border border-[#1C2A35]">
                  <p className="text-[#5EEAD4] text-xs sm:text-sm font-semibold">📚 PDF + Atualizações Vitalícias</p>
                </div>
              </div>
            </AnimatedSection>
            ...
            {/* Vídeos */}
            <AnimatedSection delay={0.4}>
              <div className="group bg-gradient-to-br from-[#0D3A46] to-[#14222E] p-4 sm:p-6 rounded-2xl border border-[#2DD4BF]/20 hover:border-[#2DD4BF] transition-all duration-300 h-full flex flex-col">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-r from-[#0D3A46] to-[#14222E] rounded-2xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-300">
                    <Play className="w-5 h-5 sm:w-7 sm:h-7 text-[#5EEAD4]" />
                  </div>
                ...
                <div className="bg-[#0B1016]/50 p-2 sm:p-3 rounded-xl border border-[#1C2A35]">
                  <p className="text-[#5EEAD4] text-xs sm:text-sm font-semibold">🎬 Acesso Imediato + Novos Vídeos Mensais</p>
                </div>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.6}>
              <div className="group bg-gradient-to-br from-[#14222E] to-[#0D3A46] p-4 sm:p-6 rounded-2xl border border-[#2DD4BF]/20 hover:border-[#2DD4BF] transition-all duration-300 h-full flex flex-col">
                <div className="flex items-center mb-3 sm:mb-4">
                  <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-r from-[#14222E] to-[#0D3A46] rounded-2xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform duration-300">
                    <Code className="w-5 h-5 sm:w-7 sm:h-7 text-[#5EEAD4]" />
                  </div>
                ...
                <div className="bg-[#0B1016]/50 p-2 sm:p-3 rounded-xl border border-[#1C2A35]">
                  <p className="text-[#5EEAD4] text-xs sm:text-sm font-semibold">🚀 Acesso Premium ao Software</p>
                </div>
              </div>
            </AnimatedSection>
          </div>
          ...
          <AnimatedSection>
            <div className="bg-[#0B1016] rounded-2xl border border-[#1C2A35] p-4 sm:p-6">
              <div className="text-center mb-4 sm:mb-6">
                <h3 className="text-xl sm:text-3xl font-bold text-white mb-2 sm:mb-4">Veja o Software Nexus AI em Ação</h3>
                <p className="text-gray-300 text-sm sm:text-lg">Interface intuitiva que reúne o poder de múltiplas IAs especializadas</p>
              </div>
              
              {/* Container visual do software */}
              <div className="bg-gradient-to-r from-[#14222E] to-[#0D3A46] p-1 rounded-xl mb-6 sm:mb-8">
                <div className="bg-[#0B1016] rounded-xl p-4 sm:p-6 border border-[#1C2A35] min-h-[200px] sm:min-h-[300px] flex flex-col justify-center">
                  {/* Interface simulada do software */}
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 mb-3 sm:mb-4">
                    <div className="bg-[#14222E] p-2 sm:p-3 rounded-lg border border-[#2DD4BF]/20 text-center">
                      <Brain className="w-4 h-4 sm:w-6 sm:h-6 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                      <p className="text-white text-xs font-semibold">IA de Análise</p>
                    </div>
                    <div className="bg-[#14222E] p-2 sm:p-3 rounded-lg border border-[#2DD4BF]/20 text-center">
                      <TrendingUp className="w-4 h-4 sm:w-6 sm:h-6 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                      <p className="text-white text-xs font-semibold">IA de Produtividade</p>
                    </div>
                    <div className="bg-[#14222E] p-2 sm:p-3 rounded-lg border border-[#2DD4BF]/20 text-center">
                      <Target className="w-4 h-4 sm:w-6 sm:h-6 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                      <p className="text-white text-xs font-semibold">IA Estratégica</p>
                    </div>
                    <div className="bg-[#14222E] p-2 sm:p-3 rounded-lg border border-[#2DD4BF]/20 text-center">
                      <Zap className="w-4 h-4 sm:w-6 sm:h-6 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                      <p className="text-white text-xs font-semibold">IA de Automação</p>
                    </div>
                  </div>
                  
                  {/* Área de preview do Dashboard */}
                  <div className="bg-[#14222E] rounded-lg p-3 sm:p-4 border border-[#1C2A35]">
                    ...
                    <div className="bg-[#0B1016] p-2 sm:p-3 rounded border border-[#1C2A35]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                {/* IA de Análise */}
                <AnimatedSection delay={0.2}>
                  <div className="group bg-gradient-to-br from-[#14222E]/30 to-[#0B1016]/30 p-3 sm:p-4 rounded-2xl border border-[#1C2A35] hover:border-[#0D3A46] transition-all duration-300 relative overflow-hidden h-full">
                    <div className="absolute inset-0 opacity-10">
                      <img src={brainAIImg} alt="IA de Análise" className="w-full h-full object-cover" />
                    </div>
                    <div className="relative z-10 text-center">
                      <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-[#14222E] to-[#0D3A46] rounded-2xl flex items-center justify-center mb-2 sm:mb-3 mx-auto group-hover:scale-110 transition-transform duration-300">
                        <Brain className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
                      </div>
                      <h3 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2">Análise Inteligente</h3>
                      <p className="text-gray-300 text-xs sm:text-sm">IA especializada em análise de dados e insights</p>
                    </div>
                  </div>
                </AnimatedSection>
                ...
                {/* IA de Produtividade */}
                <AnimatedSection delay={0.3}>
                  <div className="group bg-gradient-to-br from-[#0D3A46]/30 to-[#14222E]/30 p-3 sm:p-4 rounded-2xl border border-[#1C2A35] hover:border-[#0D3A46] transition-all duration-300 relative overflow-hidden h-full">
                    <div className="absolute inset-0 opacity-10">
                      <img src={dataAnalysisImg} alt="IA de Produtividade" className="w-full h-full object-cover" />
                    </div>
                    <div className="relative z-10 text-center">
                      <div className="w-8 h-8 sm:w-12 sm:h-12 bg-gradient-to-r from-[#0D3A46] to-[#14222E] rounded-2xl flex items-center justify-center mb-2 sm:mb-3 mx-auto group-hover:scale-110 transition-transform duration-300">
                        <TrendingUp className="w-4 h-4 sm:w-6 sm:h-6 text-white" />
                      </div>
                      <h3 className="text-sm sm:text-lg font-semibold text-white mb-1 sm:mb-2">Otimização de Processos</h3>
                      <p className="text-gray-300 text-xs sm:text-sm">Automatiza e otimiza fluxos de trabalho</p>
                    </div>
                  </div>
                </AnimatedSection>
                ...
                {/* IA Estratégica */}
                <AnimatedSection delay={0.4}>
                  <div className="group bg-gradient-to-br from-[#14222E]/30 to-[#0D3A46]/30 p-3 sm:p-4 rounded-2xl border border-[#1C2A35] hover:border-[#0D3A46] transition-all duration-300 relative overflow-hidden h-full">
                    <div className="absolute inset-0 opacity-10">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <p className="text-gray-300 text-xs sm:text-sm">IA para decisões estratégicas e planejamento</p>
                    </div>
                  </div>
                </AnimatedSection>
                ...
                <AnimatedSection delay={0.5}>
                  <div className="group bg-gradient-to-br from-[#0D3A46]/30 to-[#14222E]/30 p-3 sm:p-4 rounded-2xl border border-[#1C2A35] hover:border-[#0D3A46] transition-all duration-300 relative overflow-hidden h-full">
                    ...
                    <div className="relative z-10 text-center">
                      ...
                      <p className="text-gray-300 text-xs sm:text-sm">Automatiza tarefas complexas e repetitivas</p>
                    </div>
                  </div>
                </AnimatedSection>
              </div>
...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#0B1016] font-['Poppins',sans-serif] overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg sm:text-xl font-bold bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] bg-clip-text text-transparent">
                NEXUS
              </span>
            </div>
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/detalhes" className="text-gray-300 hover:text-[#5EEAD4] transition-colors text-sm">
                Detalhes do Sistema
              </Link>
              <Link to="/faq" className="text-gray-300 hover:text-[#5EEAD4] transition-colors text-sm">
                FAQ
              </Link>
              <Link to="/quem-somos" className="text-gray-300 hover:text-[#5EEAD4] transition-colors text-sm">
                Quem Somos
              </Link>
              <a href="https://pay.cakto.com.br/5dUKrWD" target="_blank" rel="noopener noreferrer">
                <Button size="sm" className="bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] hover:from-[#5EEAD4]/90 hover:to-[#2DD4BF]/90 text-[#0B1016] font-semibold text-xs">
                  Acessar o Sistema
                </Button>
              </a>
            </div>
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-4 pb-4 border-t border-[#1C2A35]">
              <div className="flex flex-col space-y-4 pt-4">
                <Link 
                  to="/detalhes" 
                  className="text-gray-300 hover:text-[#5EEAD4] transition-colors text-sm"
                ...
                <a href="https://pay.cakto.com.br/5dUKrWD" target="_blank" rel="noopener noreferrer">
                  <Button size="sm" className="bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] hover:from-[#5EEAD4]/90 hover:to-[#2DD4BF]/90 text-[#0B1016] font-semibold w-full text-xs">
                    Acessar o Sistema
                  </Button>
                </a>
              </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-16 overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-6xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mb-8 mt-16">
            ...
            {/* Títulos */}
            <h1 className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-3 sm:mb-4 leading-tight drop-shadow-lg">
              <Typewriter 
            ...
            <h2 className="text-xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] bg-clip-text text-transparent drop-shadow-lg mb-3 sm:mb-4">
              {typingStep >= 2 && (
                <Typewriter 
            ...
            {/* ===============================================================
            BLOCO DE TEXTO DA JUSTIFICATIVA - COMPLETAMENTE RESPONSIVO
            =============================================================== */}
            <div className="mt-4 sm:mt-6 text-xs sm:text-sm md:text-lg text-gray-200 mb-6 sm:mb-8 max-w-3xl mx-auto space-y-2 sm:space-y-4">
              <p className="text-gray-300 text-sm sm:text-base">
                O mercado está cheio de 'cursos completos' de R$ 2.000 que só entregam teoria. Você assiste 50 aulas e... nada muda.
              </p>
              
              <p className="text-base sm:text-lg md:text-2xl text-white font-semibold leading-relaxed">
              ...
              {/* Preço */}
              <p className="text-2xl sm:text-4xl md:text-5xl font-bold text-white bg-gradient-to-r from-[#F59E0B] to-[#D946EF] bg-clip-text text-transparent py-1 sm:py-2">
                12x de R$ 4,90
              </p>
            ...
            {/* ===============================================================
            BOTÕES - COMPLETAMENTE RESPONSIVOS
            =============================================================== */}
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-4 sm:mb-6">
              ...
              <a href="https://pay.cakto.com.br/5dUKrWD" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                <Button 
                  size="lg" 
                  className="bg-gradient-to-r from-[#F59E0B] to-[#D946EF] hover:from-[#F59E0B]/90 hover:to-[#D946EF]/90 text-white py-4 sm:py-6 text-sm sm:text-lg font-bold rounded-xl sm:rounded-2xl shadow-lg sm:shadow-2xl hover:shadow-[#D946EF]/40 transition-all duration-300 transform hover:scale-105 border-2 border-[#F59E0B]/50 animate-pulse w-full"
                >
              ...
              <Link to="/detalhes" className="w-full sm:w-auto">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="border-[#2DD4BF]/50 text-[#5EEAD4] hover:bg-[#2DD4BF]/10 hover:text-[#5EEAD4] py-3 sm:py-4 text-sm sm:text-lg font-semibold rounded-lg sm:rounded-xl w-full"
                >
                  <LayoutList className="w-4 h-4 sm:w-5 sm:h-5 mr-2" />
                  <span className="whitespace-nowrap">
            ...
            {/* Grid de Features */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 max-w-2xl mx-auto">
              <div className="flex items-center justify-center text-gray-300 bg-[#14222E]/30 p-2 sm:p-3 rounded-lg border border-[#1C2A35]">
                <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-2" />
                <span className="text-xs sm:text-sm">Garantia de 7 Dias</span>
              </div>
              <div className="flex items-center justify-center text-gray-300 bg-[#14222E]/30 p-2 sm:p-3 rounded-lg border border-[#1C2A35]">
                <Download className="w-4 h-4 sm:w-5 sm:h-5 text-[#5EEAD4] mr-2" />
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              <AnimatedSection delay={0.2}>
                <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#14222E] to-[#0D3A46] rounded-2xl border border-[#2DD4BF]/20">
                  ...
                  <div className="text-gray-300 text-xs sm:text-sm mt-1 sm:mt-2">Por semana com automações</div>
                </div>
              </AnimatedSection>

              <AnimatedSection delay={0.3}>
                <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#0D3A46] to-[#14222E] rounded-2xl border border-[#2DD4BF]/20">
                  <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">47</div>
                  <div className="text-white font-semibold text-sm sm:text-base">Técnicas</div>
                  <div className="text-gray-300 text-xs sm:text-sm mt-1 sm:mt-2">Comprovadas de produtividade</div>
                </div>
              </AnimatedSection>

              <AnimatedSection delay={0.4}>
                <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#14222E] to-[#0D3A46] rounded-2xl border border-[#2DD4BF]/20">
                  <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">4</div>
                  <div className="text-white font-semibold text-sm sm:text-base">IAs Integradas</div>
                  <div className="text-gray-300 text-xs sm:text-sm mt-1 sm:mt-2">No software exclusivo</div>
                </div>
              </AnimatedSection>

              <AnimatedSection delay={0.5}>
                <div className="text-center p-4 sm:p-6 bg-gradient-to-br from-[#0D3A46] to-[#14222E] rounded-2xl border border-[#2DD4BF]/20">
                  <div className="text-2xl sm:text-4xl font-bold text-[#5EEAD4] mb-1 sm:mb-2">100%</div>
                  <div className="text-white font-semibold text-sm sm:text-base">Prático</div>
                  <div className="text-gray-300 text-xs sm:text-sm mt-1 sm:mt-2">Aplicação imediata</div>
                </div>
              </AnimatedSection>
            </div>
          </div>
      ...
      {/* BANNER SCROLLING */}
      <div className="py-4 sm:py-6 bg-[#0B1016] border-y-2 border-[#1C2A35]">
        <ScrollingBanner speed={10}>
          <div className="flex items-center text-base sm:text-xl font-bold text-gray-300">
            <Brain className="w-5 h-5 sm:w-7 sm:h-7 mx-4 sm:mx-6 text-[#5EEAD4]" />
            <span>SISTEMA COMPLETO</span>
            <Sparkles className="w-5 h-5 sm:w-7 sm:h-7 mx-4 sm:mx-6 text-[#2DD4BF]" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            <AnimatedFromLeft delay={0.2}>
              <div className="bg-[#14222E]/50 p-4 sm:p-6 rounded-2xl border border-[#1C2A35] flex flex-col items-center text-center h-full">
                <img src={testimonial1Img} alt="Depoimento de Aluno 1" className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#2DD4BF] mb-3 sm:mb-4" />
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-gray-400 text-sm">Gerente de Projetos</p>
                </div>
              </div>
            </AnimatedFromLeft>
            <AnimatedSection delay={0.4}>
              <div className="bg-[#14222E]/50 p-4 sm:p-6 rounded-2xl border border-[#1C2A35] flex flex-col items-center text-center h-full">
                <img src={testimonial2Img} alt="Depoimento de Aluno 2" className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#2DD4BF] mb-3 sm:mb-4" />
                <p className="text-gray-300 italic mb-3 sm:mb-4 text-sm sm:text-base">
                ...
                <div className="mt-auto">
                  ...
                  <p className="text-gray-400 text-sm">Desenvolvedor Sênior</p>
                </div>
              </div>
            </AnimatedSection>
            <AnimatedFromRight delay={0.2}>
              <div className="bg-[#14222E]/50 p-4 sm:p-6 rounded-2xl border border-[#1C2A35] flex flex-col items-center text-center h-full">
                 <img src={testimonial3Img} alt="Depoimento de Aluno 3" className="w-16 h-16 sm:w-20 sm:h-20 rounded-full border-2 border-[#2DD4BF] mb-3 sm:mb-4" />
                <p className="text-gray-300 italic mb-3 sm:mb-4 text-sm sm:text-base">
      ...
      <AnimatedSection>
        <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#0D3A46] to-[#14222E]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-[#0B1016] p-4 sm:p-6 rounded-2xl mb-4 sm:mb-6 border border-[#F59E0B]/50">
              <div className="grid md:grid-cols-3 gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="text-center p-3 sm:p-4">
                  <BookOpen className="w-8 h-8 sm:w-10 sm:h-10 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                ...
                <div className="text-center p-3 sm:p-4">
                  <Play className="w-8 h-8 sm:w-10 sm:h-10 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
                ...
                <div className="text-center p-3 sm:p-4">
                  <Code className="w-8 h-8 sm:w-10 sm:h-10 text-[#5EEAD4] mx-auto mb-1 sm:mb-2" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 mt-4 sm:mt-6 max-w-2xl mx-auto">
              <div className="flex items-center justify-center text-gray-300">
                <Shield className="w-3 h-3 sm:w-4 sm:h-4 text-[#5EEAD4] mr-1 sm:mr-2" />
                <span className="text-xs">7 dias de garantia total</span>
              </div>
              <div className="flex items-center justify-center text-gray-300">
                <Download className="w-3 h-3 sm:w-4 sm:h-4 text-[#5EEAD4] mr-1 sm:mr-2" />
                <span className="text-xs">Acesso imediato e vitalício</span>
              </div>
              <div className="flex items-center justify-center text-gray-300">
                <Users className="w-3 h-3 sm:w-4 sm:h-4 text-[#5EEAD4] mr-1 sm:mr-2" />
      ...
      {/* FOOTER */}
      <AnimatedSection>
        <footer className="border-t border-[#1C2A35] bg-[#0B1016]/50 py-6 sm:py-8 px-4">
           <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6">
              ...
              <div>
                ...
                <div className="space-y-1 sm:space-y-2">
                  <Link to="/detalhes" className="block text-gray-400 hover:text-[#5EEAD4] transition-colors text-sm">
                    Detalhes do Sistema
                  </Link>
                  <Link to="/faq" className="block text-gray-400 hover:text-[#5EEAD4] transition-colors text-sm">
                    Perguntas Frequentes
                  </Link>
                  <Link to="/quem-somos" className="block text-gray-400 hover:text-[#5EEAD4] transition-colors text-sm">
                    Quem Somos
                  </Link>
                </div>
              </div>
              <div>
                ...
                <a href="https://www.instagram.com/nexus0rigin" target="_blank" rel="noopener noreferrer" className="inline-flex items-center text-gray-400 hover:text-[#5EEAD4] transition-colors text-sm">
                  <Instagram className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-2" />
                  @nexus0rigin
                </a>
              </div>
            </div>
            <div className="border-t border-[#1C2A35] mt-4 sm:mt-6 pt-4 sm:pt-6 text-center">
