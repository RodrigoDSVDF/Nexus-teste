      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 py-16 overflow-hidden">
        ...
        <div className={`relative z-10 text-center max-w-4xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="mb-8 mt-16">
            ...
            <h2 className="text-xl sm:text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-[#5EEAD4] to-[#2DD4BF] bg-clip-text text-transparent drop-shadow-lg mb-3 sm:mb-4 px-2">
              {typingStep >= 2 && (
                <Typewriter 
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-4 sm:mb-6 px-2 sm:px-0">
              ...
              <Link to="/detalhes" className="w-full sm:w-auto">
                <Button 
                  variant="outline" 
                  size="lg" 
                  className="border-[#2DD4BF]/50 text-[#5EEAD4] hover:bg-[#2DD4BF]/10 hover:text-[#5EEAD4] py-3 sm:py-4 text-xs sm:text-sm font-semibold rounded-lg sm:rounded-xl w-full border-2"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 max-w-2xl mx-auto px-2 sm:px-0">
              <div className="flex items-center justify-center text-gray-300 bg-[#14222E]/30 p-2 sm:p-3 rounded-lg border border-[#1C2A35]">
                <Shield className="w-4 h-4 sm:w-4 sm:h-4 text-[#5EEAD4] mr-2" />
                <span className="text-xs sm:text-sm">Garantia de 7 Dias</span>
              </div>
              <div className="flex items-center justify-center text-gray-300 bg-[#14222E]/30 p-2 sm:p-3 rounded-lg border border-[#1C2A35]">
                <Download className="w-4 h-4 sm:w-4 sm:h-4 text-[#5EEAD4] mr-2" />
                <span className="text-xs sm:text-sm">Acesso Imediato</span>
              </div>
              <div className="flex items-center justify-center text-gray-300 bg-[#14222E]/30 p-2 sm:p-3 rounded-lg border border-[#1C2A35]">
                <Clock className="w-4 h-4 sm:w-4 sm:h-4 text-[#5EEAD4] mr-2" />
