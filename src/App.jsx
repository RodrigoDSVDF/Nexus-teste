...
// ===================================================================
// COMPONENTE VÍDEO DE LOGO ANIMADO (NO INÍCIO) - COM JANELA MAIOR
// ===================================================================
      ...
      <section className="pt-32 pb-16 sm:pt-40 sm:pb-20 px-4 bg-gradient-to-br from-[#0F172A] to-[#1A222E]">
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8 sm:mb-16">
            <div className="inline-flex items-center justify-center w-24 h-24 sm:w-32 sm:h-32 mx-auto mb-8 bg-gradient-to-br from-[#6EEBD4] to-[#3DE4CF] rounded-3xl shadow-2xl">
              <video 
                autoPlay 
                muted 
                loop 
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8 sm:mb-12 leading-relaxed">
              ...
              para maximizar seu aprendizado e produtividade em escala exponencial.
            </p>
...
// ===================================================================
// COMPONENTE RECURSOS PRINCIPAIS - COM Img.jpg NO LUGAR DE IMPLEMENTAÇÃO IMEDIATA
// ===================================================================
function FeaturesSection() {
  const features = [
    ...
    },
    {
      ...
      description: "Plataforma completa com todas as ferramentas que você precisa",
      image: Img // SUBSTITUÍDO AQUI
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-[#1A222E] border border-[#2A3A4E] rounded-2xl p-6 hover:border-[#3DE4CF]/30 transition-all duration-300 group hover:transform hover:-translate-y-2">
...
// ===================================================================
// COMPONENTE VÍDEO DE APRESENTAÇÃO - COM JANELA MAIOR
// ===================================================================
function VideoApresentacao() {
  return (
    <AnimatedSection>
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#1A222E] to-[#2A3A4E]">
        <div className="max-w-6xl mx-auto"> {/* AUMENTEI DE 4xl PARA 6xl */}
          <div className="text-center mb-8 sm:mb-12">
            ...
            <p className="text-base sm:text-xl text-gray-200 max-w-4xl mx-auto">
              Em apenas 2 minutos, descubra como o Sistema Nexus vai transformar completamente sua produtividade e forma de aprender
            </p>
          </div>
          <div className="bg-[#1A222E] rounded-2xl border border-[#2A3A4E] p-4 sm:p-6 shadow-2xl">
            ...
            <div className="mt-6 sm:mt-8 text-center">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-6">
                <div className="flex items-center justify-center text-gray-200 bg-[#2A3A4E]/50 p-4 rounded-lg border border-[#3A4A5E]">
                  <Clock className="w-5 h-5 text-[#6EEBD4] mr-3" />
                  <span className="text-sm sm:text-base">Apenas 2 minutos</span>
                </div>
                <div className="flex items-center justify-center text-gray-200 bg-[#2A3A4E]/50 p-4 rounded-lg border border-[#3A4A5E]">
                  <Brain className="w-5 h-5 text-[#6EEBD4] mr-3" />
                  <span className="text-sm sm:text-base">Explicação Completa</span>
                </div>
                <div className="flex items-center justify-center text-gray-200 bg-[#2A3A4E]/50 p-4 rounded-lg border border-[#3A4A5E]">
                  <Zap className="w-5 h-5 text-[#6EEBD4] mr-3" />
                  <span className="text-sm sm:text-base">Resultados Reais</span>
                </div>
              </div>
              <p className="text-gray-300 text-base sm:text-lg">
                <strong>Dica Profissional:</strong> Assista até o final para entender por que este sistema é diferente de tudo que você já viu no mercado.
              </p>
            </div>
          </div>
        </div>
            ...
            <AnimatedFromLeft>
              <div className="bg-[#1A222E] rounded-2xl border border-[#2A3A4E] p-6 shadow-2xl">
                ...
                <p className="text-gray-300">
                  Nossa plataforma utiliza algoritmos avançados de IA para personalizar seu aprendizado e maximizar seus resultados em tempo recorde.
                </p>
              </div>
            </AnimatedFromLeft>
            <AnimatedFromRight>
      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-br from-[#1A222E] to-[#2A3A4E]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <Link to="/faq">
              <Button variant="outline" className="border-[#6EEBD4] text-[#6EEBD4] hover:bg-[#6EEBD4] hover:text-[#1A222E] font-bold py-3 px-6 rounded-full">
...
// ===================================================================
// COMPONENTE DO PRODUTO COM BOTÃO DE COMPRA
// ===================================================================
...
function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0F172A] to-[#1A222E]">
      ...
      {/* VÍDEO NO INÍCIO - COM JANELA MAIOR */}
      <VideoLogoSection />
      <BannerSection />
      ...
      {/* SEÇÃO DO PRODUTO COM IMAGEM E BOTÃO DE COMPRA */}
      <ProductSection />
